          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center">
              <div className="flex items-center ml-3">
                ...
                <div
                  className="z-50 hidden my-4 text-base list-none bg-white divide-y divide-gray-100 rounded shadow bg-gray-700 divide-gray-600"
                  id="dropdown-user"
                >
                  ...
                  <ul className="py-1" role="none">
                    <li>
                      <a
                        href="#"
                        className="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 text-gray-300 hover:bg-gray-600 hover:text-white"
                        role="menuitem"
                      >
                        Dashboard
                      </a>
          ...
          <ul className="space-y-2 font-medium">
            ...
            <li>
              ...
              >
                ...
                <span className="inline-flex items-center justify-center px-2 ml-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full bg-gray-700 text-gray-300">
                  Pro
                </span>
              </a>
            </li>
...
const Header = () => {
  ...
  const pathsWithoutNavBar = pathname.search("/admin");
  if (pathsWithoutNavBar < 0) {
    return <HeaderOne />;
  }
  return <HeaderTwo />;
};
